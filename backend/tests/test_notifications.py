...
def _devis(praticien_id, date_emission, statut="EN_ATTENTE", montant=1000.0,
           date_decision=None, motif_refus=None):
    p = {
...
def test_notif_devis_delai_depasse(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/devis/", json=_devis(praticien_id, date_ancienne), headers=prat_headers)
...
def test_notif_devis_exactement_au_delai(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/devis/", json=_devis(praticien_id, date_limite), headers=prat_headers)
...
def test_notif_devis_recent_exclu(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/devis/", json=_devis(praticien_id, date_recente), headers=prat_headers)
...
def test_notif_devis_accepte_exclu(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/devis/", json=_devis(
        praticien_id, date_ancienne, statut="ACCEPTE",
        date_decision=TODAY
...
def test_notif_devis_refuse_exclu(sec_headers, prat_headers, praticien_id):
    date_ancienne = TODAY - timedelta(days=DELAI + 5)
    client.post("/api/v1/devis/", json=_devis(
        praticien_id, date_ancienne, statut="REFUSE",
        date_decision=TODAY, motif_refus="Trop cher"
    ), headers=prat_headers)
...
def test_notif_devis_champs_retournes(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/devis/", json=_devis(praticien_id, date_ancienne, montant=1500.0), headers=prat_headers)
...
def test_notif_devis_tri_par_urgence_decroissante(sec_headers, prat_headers, praticien_id):
    # Le plus ancien doit apparaître en premier
    client.post("/api/v1/devis/", json=_devis(praticien_id, TODAY - timedelta(days=DELAI + 2)), headers=prat_headers)
    client.post("/api/v1/devis/", json=_devis(praticien_id, TODAY - timedelta(days=DELAI + 10)), headers=prat_headers)
    client.post("/api/v1/devis/", json=_devis(praticien_id, TODAY - timedelta(days=DELAI + 5)), headers=prat_headers)
...
def test_notif_devis_delai_par_praticien(sec_headers, prat_headers, praticien_id):
    ...
    client.put(f"/api/v1/praticiens/{autre_id}/parametres",
    ...
    client.post("/api/v1/devis/", json=_devis(praticien_id, date_20j), headers=prat_headers)
    client.post("/api/v1/devis/", json=_devis(autre_id, date_20j), headers=autre_headers)
...
def test_notif_cheque_date_depassee(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=hier), headers=prat_headers)
...
def test_notif_cheque_date_aujourdhui(sec_headers, prat_headers, praticien_id):
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=TODAY), headers=prat_headers)
...
def test_notif_cheque_date_future_exclue(sec_headers, prat_headers, praticien_id):
    ...
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=demain), headers=prat_headers)

    assert client.get(URL, headers=sec_headers).json()["total"] == 0


def test_notif_cheque_sans_date_depot_exclu(sec_headers, prat_headers, praticien_id):
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=None), headers=prat_headers)
...
def test_notif_cheque_depose_exclu(sec_headers, prat_headers, praticien_id):
    hier = TODAY - timedelta(days=1)
    r = client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=hier), headers=prat_headers)
    id_cheque = r.json()["id_cheque"]
    client.put(f"/api/v1/cheques/{id_cheque}", json={"statut": "DEPOSE"}, headers=prat_headers)
...
def test_notif_cheque_champs_retournes(sec_headers, prat_headers, praticien_id):
    hier = TODAY - timedelta(days=1)
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=hier, montant=750.0), headers=prat_headers)
...
def test_notif_cheque_tri_par_urgence_decroissante(sec_headers, prat_headers, praticien_id):
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=TODAY - timedelta(days=3)), headers=prat_headers)
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=TODAY - timedelta(days=10)), headers=prat_headers)
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=TODAY - timedelta(days=1)), headers=prat_headers)
...
def test_notif_total_combine(sec_headers, prat_headers, praticien_id):
    client.post("/api/v1/devis/", json=_devis(praticien_id, TODAY - timedelta(days=DELAI + 1)), headers=prat_headers)
    client.post("/api/v1/devis/", json=_devis(praticien_id, TODAY - timedelta(days=DELAI + 2)), headers=prat_headers)
    client.post("/api/v1/cheques/", json=_cheque(praticien_id, date_depot_prevue=TODAY - timedelta(days=1)), headers=prat_headers)
